...
const JavaneseComponent = () => {
  ...
  const [likeClick, setLikeClick] = useState(() => {
    const savedLikeState = localStorage.getItem("JavaneseLikes");
    return savedLikeState ? JSON.parse(savedLikeState) : false;
  });
  const [dislikeClick, setDislikeClick] = useState(() => {
    const savedDislikeState = localStorage.getItem("JavaneseDislikes");
  ...
  useEffect(() => {
    localStorage.setItem("JavaneseLikes", JSON.stringify(likeClick));
    localStorage.setItem("JavaneseDislikes", JSON.stringify(dislikeClick));
...
export default JavaneseComponent;
